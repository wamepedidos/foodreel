...
async function createOrder(request, env) {
  ...
  const items = input.items.map((item) => ({
    ...
    selectedSauces: Array.isArray(item.selectedSauces) ? item.selectedSauces : [],
    ...
    removedIngredients: Array.isArray(item.removedIngredients) ? item.removedIngredients.map(String).filter(Boolean) : [],
