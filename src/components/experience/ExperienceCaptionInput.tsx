export function ExperienceCaptionInput({
  ...
  return (
    <label className="block">
      ...
      <textarea
        className="mt-2 min-h-20 w-full resize-none rounded-[18px] border border-white/10 bg-base px-4 py-2.5 text-sm leading-5 text-white outline-none transition placeholder:text-muted focus:border-accent/60"
        maxLength={300}
