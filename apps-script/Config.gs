...
var SHEET_HEADERS = {
  ...
  DISHES: ['id', 'restaurantId', 'categoryId', 'title', 'shortDescription', 'description', 'price', 'status', 'mainImageUrl', 'videoUrl', 'videoThumbnailUrl', 'servingSizesJson', 'servingDescription', 'spicyLevel', 'isVegan', 'isVegetarian', 'isGlutenFree', 'featuresJson', 'ingredientsJson', 'allergensJson', 'crossContaminationWarning', 'preparationTimeMin', 'preparationTimeMax', 'sauceSelectionRequired', 'minimumSauces', 'maximumSauces', 'likesCount', 'viewsCount', 'commentsCount', 'sharesCount', 'addedToOrderCount', 'ordersCount', 'sortOrder', 'createdAt', 'updatedAt', 'removableIngredientsJson'],
  ...
  ADDITIONS: ['id', 'restaurantId', 'dishId', 'name', 'description', 'price', 'available', 'defaultSelected', 'sortOrder', 'createdAt', 'updatedAt'],
